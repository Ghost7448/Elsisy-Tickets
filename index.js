...
client.on('interactionCreate', async interaction => {
    try {
        ...
        if (interaction.isStringSelectMenu() && interaction.customId === 'ticket_menu') {
            ...
            let description = '';
            if (interaction.values[0] === 'other') description = `**تم إنشاء تذكرة: 🎟️\nشكراً لتواصلك معنا 👤 ${interaction.user}\n━━━━━━━━━━━━━━━━━━━━━━━\n📌 نوع التذكرة\nتقديم علي Editor Team\n\nيرجى الإجابة على الأسئلة التالية:\n• الاسم:\n• العمر:\n• البرامج التي تستخدمها:\n• هل لديك خبرة سابقة؟\n• لماذا ترغب في الانضمام إلى Team Editors؟\n━━━━━━━━━━━━━━━━━━━━━━━\n💡 كن واضحاً ومفصلاً في شرحك.**`;
            if (interaction.values[0] === 'report') description = `**تم إنشاء تذكرة: 🎟️\nشكراً لتواصلك معنا 👤 ${interaction.user}\n━━━━━━━━━━━━━━━━━━━━━━━\n📌 نوع التذكرة\nشكاوي\n\nيرجى شرح المشكلة بالتفصيل وانتظار فريق الدعم.**`;
            if (interaction.values[0] === 'support') description = `**تم إنشاء تذكرة: 🎟️\nشكراً لتواصلك معنا 👤 ${interaction.user}\n━━━━━━━━━━━━━━━━━━━━━━━\n📌 نوع التذكرة\nدعم فني\n\nيرجى شرح المشكلة بالتفصيل وانتظار فريق الدعم.**`;
            if (interaction.values[0] === 'management') description = `**تم إنشاء تذكرة: 🎟️\nشكراً لتواصلك معنا 👤 ${interaction.user}\n━━━━━━━━━━━━━━━━━━━━━━━\n📌 تقديم علي Mod Kick\n\nيرجى الإجابة على الأسئلة التالية:\n• الاسم:\n• العمر:\n• عدد ساعات التواجد اليومية:\n• لماذا ترغب في الانضمام إلى فريق Mod Kick؟\n• هل لديك أي خبرة سابقة؟**`;
